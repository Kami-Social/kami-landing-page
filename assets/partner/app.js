...
import { renderPartnerDashboard, readTabFromUrl } from "./dashboard.js?v=20260617c";
import {
...
function setRoot(html, { publicLanding = false } = {}) {
  ...
  if (publicLanding) {
    ...
    document.body.classList.remove("partner-dashboard");
  } else {
    clearPublicLandingMode();
  }
  ROOT.innerHTML = html;
...
function hideModal() {
  ...
  document.dispatchEvent(new CustomEvent("partner-modal-close"));
}
