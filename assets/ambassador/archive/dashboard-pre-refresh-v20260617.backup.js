...
function renderLedgerTableBody(entries, offset = 0) {
  ...
  if (!pageEntries.length) {
    return `<tr><td colspan="5" class="empty-cell">No change history yet.</td></tr>`;
  }
...
async function renderDashboard() {
  ...
  const ledgerPagination = renderChangeLedgerPagination(ledgerEntries, 0);
  ...
  setRoot(`
    ...
    <section class="panel table-panel" data-change-ledger>
      <h2>Change Ledger</h2>
      ...
      <div data-change-ledger-footer>${ledgerPagination}</div>
    </section>
