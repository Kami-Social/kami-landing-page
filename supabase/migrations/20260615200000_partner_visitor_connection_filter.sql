-- Add connection-status filter to partner venue visit history.

drop function if exists public.get_my_partner_venue_visit_history(uuid, uuid, text, text, integer, integer);
...
revoke all on function public.get_my_partner_venue_visit_history(uuid, uuid, text, text, text, integer, integer) from public;
grant execute on function public.get_my_partner_venue_visit_history(uuid, uuid, text, text, text, integer, integer) to authenticated;
